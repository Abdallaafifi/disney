  ...
  return (
    <div className="  md:my-6 my-6   select-none ">
      ...
      <div className="flex items-center relative group">
        ...
        <div
          id={`slider` + keyId}
          className={` slide   md:mt-0 mt-2 flex items-center justify-between md:min-h-full    cursor-pointer hover:opacity-100 relative gap-3 md:gap-[1.5rem] w-full md:px-2 overflow-x-scroll scroll-smooth   scrollbar-hide `}
        >
          {movies.map((item, id) => (
